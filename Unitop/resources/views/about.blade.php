	...
	<div class="row">
        ...
        <div class="col-12 d-flex justify-content-center align-items-center text-center">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 d-flex justify-content-center align-items-center">
                            <div class="text-left">
                                ...
                                <p>Corporate culture is not something that is brought in from abroad; rather, it is the culmination of many years of cultural experience within the company, and it serves as the theoretical foundation for guiding the company's growth and development.
                                </p>
                            </div>
                    </div>
                    <div class="col-lg-6">
                        <img src="{{URL('storage/Picture1.png')}}" class="img-responsive" style="width:100%">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <img src="{{URL('storage/Picture2.png')}}" class="img-responsive" style="width:100%">
                    </div>
                    <div class="col-lg-6 d-flex justify-content-center align-items-center">
                            <div class="text-left">
                                <h4>Business Objectives</h4>
                                <p>Quality first, aiming to lead the industry based on moral principles and providing genuine customer service.</p>
                ...
                <div class="row">
                    <div class="col-lg-6 d-flex justify-content-center align-items-center">
                            <div class="text-left">
                                ...
                                <p>We are the source manufacturer: Because we are the source with the best cost control, our products lead the peer group with high quality and affordable prices.</p>
                                
                            </div>
                    </div>
                    <div class="col-lg-6">
                        <img src="{{URL('storage/Picture3.png')}}" class="img-responsive" style="width:100%">
                    </div>
                </div>
